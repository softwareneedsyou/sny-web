            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8" id="Corps_pop">
                        <h4 class="modal-title text-center" id="titre_pop_up">Saisir les données</h4><br>
                        ...
                        <div class="button-group">
                            <label>Pseudo</label>
                            <input type="text" class="form-control text-center" id="editUserPseudo" placeholder="Pseudo" >
                        </div>
